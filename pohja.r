...
#setwd('Z:/Documents') #RStudiossa t‰m‰n voi tehd‰ myˆs valikosta Session->Set working directory
#Luetaan s‰hkˆnkulutus- ja l‰mpˆÜtiladata, hyp‰t‰‰nn headerrivin yli
eletemp = read.table(file = "sahko.csv", sep = ";", dec = ",", skip = 1)

#S‰hkˆnkulutus aikasarjaksi
ele = ts(eletemp[[1]][1:816], start = 1, frequency = 24)

#L‰mpˆtila kahdeksi aikasarjaksi: 816 ensimm‰ist‰ havaintoa k‰ytet‰‰n mallin estimointiin ja 24 viimeist‰ havaintoa ennustamiseen.
...
#Stationarisoidaan aikasarjat. Huomaa, ett‰ s‰hkˆnkulutuksen ja l‰mpˆtilan aikasarjojen differointien asteiden ei v‰ltt‰m‰tt‰ tarvitse olla samoja. Sijoita differoinnin kertaluku d, kausidifferoinnin jakso S, kausidifferensoinnin kertaluku D ja poista rivit 24-28 kommenteista.
#d = ?
#S = ?
#D = ?
dele = ele
...
#Estimoidaan malli l‰mpˆtilan kanssa. M‰‰r‰‰ l‰mpˆtilan mahdollinen viive L. Poista #-merkit riveilt‰ 47-52.
#L = ?
